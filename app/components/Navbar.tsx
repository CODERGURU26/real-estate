...
export default function Navbar() {
  ...
  const navItems = [
    { href: "/home", label: "Home", icon: FiHome, show: pathname !== "/" },
    { href: "/contact", label: "Contact Us", icon: FiPhone, show: true },
    { href: "/aboutus", label: "About Us", icon: FiInfo, show: true },
                    ...
                    {status === "loading" ? (
                      ...
                      >
                        <Link
                          ...
                          className={`flex items-center space-x-3 px-4 py-3 rounded-lg border-2 transition-colors ${
                            scrolled ? "border-blue-600 text-blue-600" : "border-white text-white"
                          }`}
                          onClick={() => setMenuOpen(false)}
                        >
                      ...
                      >
                        ...
                        {isAdmin && !onAdminPage && (
                          <Link
                            href="/admin"
                            className="flex items-center space-x-3 bg-gradient-to-r from-yellow-400 to-orange-400 text-black px-4 py-3 rounded-lg font-medium"
                            onClick={() => setMenuOpen(false)}
                          >
                        ...
                        <button
                          ...
                          className="w-full flex items-center space-x-3 bg-red-500 hover:bg-red-600 text-white px-4 py-3 rounded-lg font-medium transition-colors"
                        >
